...
// Maps language → CSS variable name (defined in globals.css)
...
// Show only the first 4 lines of code in the preview
...
export function SnippetCard({ snippet }: SnippetCardProps) {
  ...
  return (
    <Link href={`/snippets/${snippet.id}`} className="block h-full">
      <Card className="card-shimmer group h-full flex flex-col overflow-hidden border-border/60 transition-all duration-200 hover:-translate-y-0.5 hover:border-border hover:shadow-lg">
