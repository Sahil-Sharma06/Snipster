    ...
    <header className="fixed top-0 right-0 w-full md:w-[calc(100%-6rem)] z-40 flex justify-between items-center h-16 px-6 md:px-8 bg-[#131313]/70 backdrop-blur-xl border-b border-white/5">
      <div className="flex items-center flex-1 max-w-xl">
        <div className="relative w-full group">
          <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-sm">explore</span>
          <Link href="/explore">
            <input
              ...
              placeholder="Explore the monolith..."
              type="text"
              readOnly
            />
          </Link>
