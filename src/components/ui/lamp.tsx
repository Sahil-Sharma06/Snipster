...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[100vh] flex-col items-center justify-center overflow-hidden bg-[#0a0a0a] w-full rounded-md z-0",
        className
      )}
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 flex flex-col items-center px-5 w-full text-center">
        {children}
      </div>
    </div>
  );
